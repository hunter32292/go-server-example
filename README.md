# Go Server Example
[![build status](https://github.com/jessemillar/go-server-example/actions/workflows/build-status.yml/badge.svg)](https://github.com/jessemillar/go-server-example/actions/workflows/build-status.yml)
